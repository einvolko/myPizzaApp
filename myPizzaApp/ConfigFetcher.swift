...
class ConfigFetcher {
    ...
    let configURL = URL(string: "https://raw.githubusercontent.com/einvolko/myPizzaApp/main/Source/PizzaSource.json?token=GHSAT0AAAAAAB7THJVRLEHAYAJYZYNCJUQYZATIT6A")!
